...
from dolfinx_materials.solvers import NonlinearMaterialProblem, CustomNewtonProblem
...
problem = CustomNewtonProblem(qmap, Res, Jac, T, bcs, rtol=1e-4)

from petsc4py import PETSc

newton = PETSc.KSP().create(domain.comm)
